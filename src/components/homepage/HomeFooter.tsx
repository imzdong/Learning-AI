    ...
    <footer className="bg-secondary-900">
      ...
      >
        <div className="flex items-center gap-3">
          <Link href="https://github.com/imzdong/Learning-AI">
            <GitHubLogoIcon className="h-6 w-6 text-zinc-400 hover:text-primary" />
          </Link>
        </div>
        <div className="flex-1 text-zinc-400 lg:text-right">
          <div className="flex-1 text-zinc-400 lg:text-right">
            Build with Winter and <span className="emoji">❤️</span>.
            Website template copy from <a target={"_blank"} href={"https://github.com/thinkingjimmy/Learning-Prompt"}>Jimmy</a>
          </div>
          This website uses <a target={"_blank"} href={"https://docs.dyte.io/"}>dyte.io</a> theme, thanks for dyte.io. and Jimmy 
        </div>
      </div>
      <div
